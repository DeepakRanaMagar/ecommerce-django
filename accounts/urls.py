...
from .views import CustomerRegistrationView, MerchantRegistrationView, UserLoginView, UserLogoutView,CustomerList, MerchantList
...
urlpatterns = [
    ...
    path('merchants/', MerchantList.as_view(), name='CustomerList'),
